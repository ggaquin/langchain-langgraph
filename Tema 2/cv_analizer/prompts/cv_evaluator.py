...
def evaluar_candidato(texto_cv: str, descripcion_puesto: str) -> AnalisisCV:
    ...
    try:
        ...
        return AnalisisCV(
            ...
            experiencia_años=0,
            habilidades_clave=["Error en procesamiento CV"],
            educacion="No se pudo determinar",
            experiencia_relevante="Error duante el análisis",
            fortalezas=["Requiere revisipon manual del CV"],
            areas_mejora=["Verificar formato y legobilifaf del PDF"],
            porcebtaje_ajuste=0
        )
