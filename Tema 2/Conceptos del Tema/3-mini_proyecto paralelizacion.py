...
sumary_branch = RunnableLambda(generate_summary)
...
parallel_analysis = RunnableParallel({
    "resumen": sumary_branch,
    "sentimiento_data": sentiment_branch
})

# cadena con paralelización de tareas
chain = preprocesador | parallel_analysis | merger
...
# Se evalua en forma batch para aprovechar aun mas el parelelismo
